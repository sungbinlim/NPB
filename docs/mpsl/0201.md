...
- 위 표현을 기호로 나타내면 <img src="{{ site.baseurl }}/images/mpsl_Figure040101.png" width="1%" height="11%" /> \\( \in \\) <img src="{{ site.baseurl }}/images/mpsl_Figure040102.png" width="10%" height="10%" /> 로 쓸 수 있다
