...
<img src="{{ site.baseurl }}/images/mpsl_Figure040101.png" width="10%" height="10%" /> \\( \ \in \ \\) <img src="{{ site.baseurl }}/images/mpsl_Figure040102.png" width="30%" height="30%" />


- 보통 원소 \\( x \\) 는 흔히들 하나의 숫자를 떠올리곤 하지만 MNIST 이미지처럼 행렬을 원소로 가질수도 있고, 텐서, 심지어 함수 자체를 원소로 가질 수 있다

<img src="{{ site.baseurl }}/images/mpsl_Figure040103.png" width="20%" height="20%" />
