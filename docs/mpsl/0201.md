...
- 이미지 <img src="{{ site.baseurl }}/images/mpsl_Figure040101.png" width="10%" height="10%" /> 는 는 MNIST <img src="{{ site.baseurl }}/images/mpsl_Figure040102.png" width="10%" height="10%" /> 의 원소라고 말할 수 있다
