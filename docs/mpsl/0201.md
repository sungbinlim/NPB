...
<img src="{{ site.baseurl }}/images/mpsl_Figure040101.png" width="10%" height="10%" />

![figure1.1]({{ site.baseurl }}/images/mpsl_Figure040101.png){: width = "1%" height = "1%"}

\\( \ \in \ \\) 

![figure1.2]({{ site.baseurl }}/images/mpsl_Figure040102.png){: width = "1%" height = "1%"}
