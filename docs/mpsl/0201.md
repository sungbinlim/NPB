...
\\(\qquad \qquad \qquad \\) <img src="{{ site.baseurl }}/images/mpsl_Figure040101.png" width="10%" height="10%" /> \\( \ \in \ \\) <img src="{{ site.baseurl }}/images/mpsl_Figure040102.png" width="10%" height="10%" />
